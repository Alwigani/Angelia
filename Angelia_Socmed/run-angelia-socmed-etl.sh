...
BASE_LOG_DIR=/data/cms/hnat_reflex/angelia/socmed/script
...
JAR_FILE=${BASE_DIR}/Angelia.jar
CLASS_NAME=Angelia.Socmed_step1
CLASS_NAME_FINAL=Angelia.Socmed_final
...
#-conf information
getMaxLoop
HFS_LIST_DIR=/data/out/angelia/socmed/list
HFS_REJECT_DIR=/data/out/angelia/socmed/rej/${PERIODE}/${JOB_ID_LOWER}
HFS_OUTPUT_CLEAN_DIR=/data/out/angelia/socmed/ok/${PERIODE}
HFS_OUTPUT_FINAL_DIR=/data/out/angelia/socmed/final/${PERIODE}
...
TABLE_NAME=STG_ANGELIA_SOCMED_PROFILE  
...
ALTER TABLE ${TABLE_NAME} ADD IF NOT EXISTS PARTITION(FILEDATE = ${PERIODE}); 

LOAD DATA INPATH '${HFS_OUTPUT_FINAL_DIR}' INTO TABLE ${TABLE_NAME} PARTITION(FILEDATE = ${PERIODE});
