...
BASE_LOG_DIR=/data/cms/hnat_reflex/angelia/ems/script
...
CLASS_NAME=Angelia.Ems_step1
CLASS_NAME_FINAL=Angelia.Ems_final
...
#-conf information
getMaxLoop
HFS_LIST_DIR=/data/out/angelia/ems/list
HFS_REJECT_DIR=/data/out/angelia/ems/rej/${PERIODE}/${JOB_ID_LOWER}
HFS_OUTPUT_CLEAN_DIR=/data/out/angelia/ems/ok/${PERIODE}
HFS_OUTPUT_FINAL_DIR=/data/out/angelia/ems/final/${PERIODE}
...
TABLE_NAME=STG_ANGELIA_EMS_PROFILE  
