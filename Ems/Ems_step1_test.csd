<?xml version="1.0"?>
    <HGrid247 version="2.3.5">
        ...
        <Each>
            <name> Transformator_1512447141592</name>
            <ID> 1512447141592</ID>
            <label> Transformator_2</label>
            <prevPipe> Transformator_1511432425207</prevPipe>
           <type> EACH</type>
            <pipeName> </pipeName>
            ...
            <enabledCounter> true</enabledCounter>
            <description> </description>
            <argumentSelector> ID,ID_MATRIK,NO_TIKET,TGL_EMAIL,EMAILFROM,EMAILNAME,STATUS_EMAIL,STATUS_TIKET,CIF,PRODUK,SUB_PRODUK,EMAIL_TYPE,KATEGORI,SUB_KATEGORI,CASENYA,CLASSY,UPD,AGENT_PICKUP,AGENT_SUBMIT,LUP,MSISDN</argumentSelector>
            <outputSelector> </outputSelector>
            <fieldDeclaration> </fieldDeclaration>
            <posxIR> 22</posxIR>
            <posyIR> 22</posyIR>
        ...
        <Transform>
            <parentID> 1512447141592</parentID>
            <prevIDS> </prevIDS>
            <nextIDS> </nextIDS>
            <ID> 1512447156929</ID>
        ...
        <Pipe2Hfs>
            <fromID> 1512447141592</fromID>
            <toID> 1511506537822</toID>
        </Pipe2Hfs>
        <Pipe2Pipe>
        ...
        <HfsSink>
            ...
            <path> </path>
            <sinkMode> </sinkMode>
            <label> Hfs_sink_2</label>
             <hfsName> Hfs_sink_1511506537822</hfsName>
            <ID> 1511506537822</ID>
            <type> HFSSINK</type>
            <posx> 598.0</posx>
            <posy> 244.0</posy>
